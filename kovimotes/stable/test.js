...
KoviMotes.Script = function(){
              ...
              for(let c = 0; c < words.length; c++){
                ...
                if(word.indexOf(":") > -1){
                  ...
                  if(word.indexOf(":") == 0){
                    ...
                    if(typeof prev.classList != "undefined"){
                      let emote;
                      ...
                      if(typeof emote != "undefined"){
                        ...
                        for(let d = 1; d < mods.length; d++){
                          if(self.emoteMods.indexOf(mods[d]) > -1 && !has_mod){
                            if(typeof emote.tagName != "undefined" && typeof emote.className != "undefined"){
  ...
  this.restart = function(){
    ...
    (function(){let js = document.createElement("script"); js.id = "KoviMotes JS"; js.type = "text/javascript"; js.src = "https://kovibear.tv/kovimotes/stable/test.js"; document.head.appendChild(js);})()
  }
}

KoviMotes = new KoviMotes.Script()

// temporary 15m auto-update timeout to deal with likely constant blacklist updates
setTimeout(function(){
  KoviMotes.restart()
},900000)
